...
%CMAKE% --build %CD%/../src --target ALL_BUILD --config Release -- /v:m /clp:ShowCommandLine;Summary /m:%THREADS%
%CMAKE% --build %CD%/../src --target INSTALL --config Release -- /v:m /clp:ShowCommandLine;Summary /m:%THREADS%
