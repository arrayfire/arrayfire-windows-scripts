...
if "%GRAPHICS%"=="ON" (
    SET GRAPHICS_OPTIONS=-DGLEW_INCLUDE_DIR:STRING="%DEPS_DIR%/glew/include" -DGLEW_LIBRARY="%DEPS_DIR%/glew/lib/glew32.lib" -DGLEWmx_LIBRARY="%DEPS_DIR%/glew/lib/glew32mx.lib" -DGLFW_INCLUDE_DIR:STRING="%DEPS_DIR%/glfw/include" -DGLFW_LIBRARY="%DEPS_DIR%/glfw/lib-vc2013/glfw3.lib"
