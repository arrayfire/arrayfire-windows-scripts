...
if "%GRAPHICS%"=="ON" (
    SET GRAPHICS_OPTIONS=-DUSE_GLEWmx_STATIC:BOOL=%GLEWmx_STATIC% -DGLEW_INCLUDE_DIR:STRING="%GLEW_DIR%/include" -DGLEW_LIBRARY="%GLEW_DIR%/lib/glew32.lib" -DGLEWmxd_LIBRARY="%GLEW_DIR%/lib/glew32mx.lib" -DGLEWmxs_LIBRARY="%GLEW_DIR%/lib/glew32ms.lib" -DGLFW_INCLUDE_DIR:STRING="%GLFW_DIR%/include" -DGLFW_LIBRARY="%GLFW_DIR%/lib/glfw3.lib"
