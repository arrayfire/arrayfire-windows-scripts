...
if "%CPU_LAPACK_TYPE%"=="LAPACKE" (
	...
	REM SET MKL PATH HERE
	SET LAPACK_OPTIONS=-DUSE_CPU_MKL:BOOL=ON -DUSE_OPENCL_MKL:BOOL=ON -DLAPACKE_INCLUDES:STRING="%MKL_DIR%/include" -DLAPACKE_LIB:STRING="%MKL_DIR%/lib/mkl_core_dll.lib;" -DLAPACK_LIB:STRING="%MKL_DIR%/lib/mkl_rt.lib"
	SET PATH_EXT=%PATH_EXT%%MKL_DIR%\bin;
)
